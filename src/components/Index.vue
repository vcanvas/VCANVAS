...
<script>
import vcCanvas from "./canvas.vue";
import vcToolbar from "./toolbar.vue";
import vcMenubar from "./menubar.vue";
import vcBottom from "./bottom.vue";
...
export default {
  ...
  components: { vcToolbar, vcCanvas, vcMenubar, vcBottom },
  methods: {
    rightClick(e) {
